    ...
    for n,shape in enumerate(sf.shapeRecords()[i1:i2]):
        ...
        if args.append==0:
            ...
            if os.path.isfile(ofile) and args.skip==1:
                ...
                continue
        log.info('Working on shape {} ({} of {} total)'.format(iname,n,i2-i1))
        if args.append==0:
            out = template.copy()
...
def parse_args():
    ...
    p.add_argument('-f', '--figure',type=str,help='figure file',default="mask_{:02d}.png")
